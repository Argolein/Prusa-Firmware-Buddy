...
bool append_move_segments_to_queue(const block_t &block) {
    ...
    if (accel_dist != 0.) {
        ...
        if (!append_move_segment_to_queue(accel_t, start_v, half_accel, print_time, axes_r, start_pos, flags, block.pressure_advance_value)) {
    ...
    if (cruise_dist != 0.) {
        ...
        if (!append_move_segment_to_queue(cruise_t, cruise_v, 0., print_time, axes_r, start_pos, flags, block.pressure_advance_value)) {
    ...
    if (decel_dist != 0.) {
        ...
        if (!append_move_segment_to_queue(decel_t, cruise_v, -half_accel, print_time, axes_r, start_pos, flags, block.pressure_advance_value)) {
